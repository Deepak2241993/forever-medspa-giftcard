                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box text-bg-primary">
                            <div class="inner">
                                <a href="{{ route('cardgenerated-list') }}" class="small-box-footer">
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box text-bg-dark">
                            <div class="inner">
                                <a href="{{ route('giftcardredeem-view') }}" class="small-box-footer">
                                    <h3>{{ $cardnumbers }}</h3>
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box text-bg-dark">
                            <div class="inner">
                                <a href="{{ route('coupon.index') }}" class="small-box-footer">
                                    <h3>{{ $giftCoupon }}</h3>
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box text-bg-warning">
                            <div class="inner">
                                <a href="{{ route('keywords_reports') }}" class="small-box-footer">
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box text-bg-warning">
                            <div class="inner">
                                <a href="{{ route('service-order-history.index') }}" class="small-box-footer">
                                    <h3>{{ $TotalServiceSale }}</h3>

                                    <p>Total Service Purchases</p>
                                </a>
                            </div>
                            <svg class="small-box-icon" fill="currentColor" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box text-bg-warning">
                            <div class="inner">
                                <a href="{{ route('cancel-service') }}" class="small-box-footer">
                                    <h3>{{ $cancel_deals }}</h3>
