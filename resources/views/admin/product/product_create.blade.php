                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-lg-6 self">
                            ...
                            <input class="form-control" type="text" name="product_slug"
                                value="{{ isset($data) ? $data['product_slug'] : '' }}" placeholder="Slug" id="product_slug">
                        </div>
                    ...
                    "
                        ...
                        <div class="mb-3 col-lg-6 self">
                            ...
                            <input class="form-control" type="number" min="0" name="amount"
                                value="{{ isset($data) ? $data['amount'] : '' }}" placeholder="Service Original Price"
                                required>
                        ...
                        <div class="mb-3 col-lg-6 self">
                            ...
                            <input class="form-control" type="number" min="0" name="discounted_amount"
                                value="{{ isset($data) ? $data['discounted_amount'] : '' }}" placeholder="Service Price"
                                required>
                        </div>
                        <div class="mb-3 col-lg-6 self">
                            ...
                            <input class="form-control" type="number" min="1" name="session_number"
                                value="{{ isset($data) ? $data['session_number'] : '1' }}" placeholder="Number Of Session"
                                required>
                        </div>
                        ...
                        <div class="mb-3 col-lg-6">
                            ...
                            <select class="form-control" name="giftcard_redemption" id="from">
                                <option
                                    value="1"{{ isset($data['giftcard_redemption']) && $data['giftcard_redemption'] == 1 ? 'selected' : '' }}>
                                    Yes</option>
                                <option
                                    value="0"{{ isset($data['giftcard_redemption']) && $data['giftcard_redemption'] == 0 ? 'selected' : '' }}>
                                    No</option>
                            </select>
                        </div>
