                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-lg-6 self">
                            ...
                            <input class="form-control" id="slug" type="text" name="slug"
                                value="{{ isset($data) ? $data['slug'] : '' }}" placeholder="Category slug">
                        </div>
                        <div class="mb-3 col-lg-6 self">
                        ...
                        @if (isset($data))
                            <div class="mb-3 col-lg-6 mt-4 self">
                                ...
                                @isset($data['cat_image'])
                                    <div id="image_class">
                                        <img src="{{ $data['cat_image'] }}"style="width:80%; height:100px;"><span>
                                            <buttom class="btn btn-danger" onclick="hideImage()">X</buttom>
                                        </span>
                                    </div>
                                @endisset
                                <div id="image_field"
                                    @if ($data['cat_image'] != '') style="display:{{ isset($data['id']) ? 'none' : 'block' }}" @endif>
