        ...
        <div class="app-content">
            ...
            <div class="container-fluid">
                ...
                <div class="card-body p-4">
                    @if (isset($medsapGift))
                        <form method="post" action="{{ route('medspa-gift.update', $medsapGift->id) }}"
                    ...
                    <div class="row">
                        <div class="mb-3 col-lg-6 self">
                            ...
                            <input class="form-control" type="text" name="title"
                                value="{{ isset($medsapGift) ? $medsapGift->title : '' }}" placeholder="Card Title">
                        </div>
                                ...
                                <select class="form-control" name="category_id" required>
                                    ...
                                    @foreach ($gatcategory as $key => $value)
                                        <option value="{{ $value->id }}"
                                            {{ isset($medsapGift) && $medsapGift->category_id == $value->id ? 'selected' : '' }}>
                                            {{ $value->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="mb-3 col-lg-6 self">
                                ...
                                <select class="form-control" name="template_id" required>
                                    ...
                                    @foreach ($template as $key => $value)
                                        <option
                                            value="{{ $value->id }}"{{ isset($medsapGift) && $medsapGift->template_id == $value->id ? 'selected' : '' }}>
                                            {{ $value->title }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="mb-3 col-lg-6 self">
                            ...
                            <input class="form-control" id="amount" type="number" min="1" name="amount"
                                value="{{ isset($medsapGift) ? $medsapGift->amount : '' }}" placeholder="Giftcard Amount">
                        </div>
                        <div class="mb-3 col-lg-6 self">
                            <label for="image" class="form-label">Giftcard Image</label>
                            <input class="form-control" id="image" type="file" name="image"
                                value="{{ isset($medsapGift) ? $medsapGift->amount : '' }}">
                        </div>
                        ...
                        <div class="mb-3 col-lg-6">
                            ...
                            <select class="form-control" name="status" id="from">
                                <option
                                    value="1"{{ isset($medsapGift->status) && $medsapGift->status == 1 ? 'selected' : '' }}>
                                    Active</option>
                                <option
                                    value="0"{{ isset($medsapGift->status) && $medsapGift->status == 0 ? 'selected' : '' }}>
                                    Inactive</option>
                            </select>
                        </div>
                        <div class="form-check form-switch form-switch-lg mt-4 col-lg-6" dir="ltr">
                            <input type="checkbox" name="coupon_code" class="form-check-input" id="customSwitchsizelg"
                                {{ isset($medsapGift) && $medsapGift->coupon_code == 1 ? 'checked' : '' }}>
