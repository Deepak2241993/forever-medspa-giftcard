                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td class="m_-1377519352946152473content"
                                                                                ...
                                                                                <h1 style="font-weight:300;font-size:28px;line-height:130%;margin:16px 0 0"
                                                                                    align="center">Giftcard Statement
                                                                                </h1>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="m_-1377519352946152473content"
                                                                                ...
                                                                                <p style="margin:0 0 1em">Dear
                                                                                    {{ $gifcardCancelData['receiverAndSenderDetails']['your_name'] }},
                                                                                </p>
                                                                                <p>As per your request, the Giftcard
                                                                                    with serial number :
                                                                                    {{ $gifcardCancelData['result'][0]['giftnumber'] }}
                                                                                    has been cancelled and is considered
                                                                                    invalid for all further use.</p>
