                   ...
                   <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                       ...
                       <div class="row">
                           <div class="col-md-12 mx-0">
                            ...
                            @endif
                               <form id="msform" class="some_one_else_div" Method="post"action="{{route('giftcard-purchase')}}">
                                 @csrf
                                   <!-- progressbar -->
                                   <ul id="progressbar">
                               ...
                               <form id="msform" class="self_div" Method="post"action="{{route('giftcard-purchase')}}">
                                 @csrf
                                   <!-- progressbar -->
                                   <ul id="progressbar">
                                       <li class="active" id="account"><strong>Account</strong></li>
