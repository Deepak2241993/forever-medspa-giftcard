                            ...
                            <div class="auth-content my-auto">
                                <div class="text-center">
                                    ...
                                    <div class="mt-4 pt-2">
                                        ...
                                        <p class="text-muted font-size-15">Thank you for using <span class="fw-semibold text-dark">Forever Medspa</span></p>
                                        <div class="mt-4">
                                ...
                                <div id="reviewcarouselIndicators" class="carousel slide" data-bs-ride="carousel">
                                    <div class="carousel-indicators auth-carousel carousel-indicators-rounded justify-content-center mb-0">
                                        <button type="button" data-bs-target="#reviewcarouselIndicators" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1">
                                            <img src="assets/images/users/avatar-1.jpg" class="avatar-md img-fluid rounded-circle d-block" alt="..."onerror="this.onerror=null; this.src='{{url('/No_Image_Available.jpg')}}';">
                                        </button>
                                        <button type="button" data-bs-target="#reviewcarouselIndicators" data-bs-slide-to="1" aria-label="Slide 2">
                                            <img src="assets/images/users/avatar-2.jpg" class="avatar-md img-fluid rounded-circle d-block" alt="..."onerror="this.onerror=null; this.src='{{url('/No_Image_Available.jpg')}}';">
                                        </button>
                                        <button type="button" data-bs-target="#reviewcarouselIndicators" data-bs-slide-to="2" aria-label="Slide 3">
                                            <img src="assets/images/users/avatar-3.jpg" class="avatar-md img-fluid rounded-circle d-block" alt="..."onerror="this.onerror=null; this.src='{{url('/No_Image_Available.jpg')}}';">
                                        </button>
                                    </div>
