                        ...
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="auth-content my-auto">
                                <div class="text-center">
                                    ...
                                    <p class="text-muted mt-2">Get your free ForeverMedspa Giftcards account now.</p>
                                </div>
                                <form class="needs-validation mt-4 pt-2" novalidate method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-4">
                                        <p class="mb-0">By registering you agree to the ForeverMedspa Giftcards <a href="#" class="text-primary">Terms of Use</a></p>
                                    </div>
                                    <div class="mb-3">
