      ...
      <div class="row container">
         @if(isset($data) && $data['status']!=404)
            ...
            <div class="left-column content-box">
                   <img src="{{$value['product_image']}}" alt="Product Image">
            </div>
         
            <div class="right-column content-box">
                  <h2 class="head">{{$value['product_name']}}</h2>
                  <span class="product-old-price"><del>${{$value['amount']}}</del></span></span>
                  <span class="product-new-price">${{$value['discounted_amount']}}</span>
                  <ul>
