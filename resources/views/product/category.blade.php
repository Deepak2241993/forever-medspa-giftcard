...
@push('css')
    ...
    <style>
        ...
        <blade media|%20(max-width%3A%20767px)%20%7B>main {
            margin-top: 20px;
        }
...
<body>
    ...
    <main>
        ...
        {{-- <div class="breadcrumb__area theme-bg-1 p-relative z-index-11 pt-95 pb-95">
         <div class="breadcrumb__thumb" data-background="{{ url('/uploads/FOREVER-MEDSPA') }}/med-spa-banner.jpg">
        </div>
        <div class="container">
                            ...
                            @if(isset($data))
                                @foreach($data as $value)
                                    ...
                                    @php
                                        ...
                                        $daysLeft = $dealEndDate->diffInDays($today, false); // 'false' allows for
                                        negative values if the date is in the past
                                    @endphp
                                    {{-- {{dd($product) }} --}}
                                    <blade
                                        if|(%24product%20%26%26%20%24daysLeft%20%3C%200%20%7C%7C%20%24daysLeft%20%3D%3D%200)>
                                        <article class="postbox__item mb-50 transition-3">
                                            <div class="postbox__thumb w-img mb-30">
                                                <a
                                                    href="{{ route('product', ['slug' => $value['slug']]) }}">
                                            ...
                                            <div class="postbox__content">
                                                ...
                                                <h3 class="postbox__title">
                                                    <a
                                                        href="{{ route('product', ['slug' => $value['slug']]) }}">{{ $value['cat_name'] }}</a>
                                                </h3>
                                ...
                                <div class="sidebar__widget-content">
                                    <div class="sidebar__search">
                                        <form autocomplete="off"
                                            action="{{ route('ServicesSearch') }}" method="post">
                                            @csrf
                                            <div class="sidebar__search-input">
                                                <input type="text" id="myInput" placeholder="Enter your keywords..."
                                                    name="search">
                                                <button type="submit">
...
@foreach($category as $value)
                              <li><a href="{{ route('productCategory', ['id' => $value->id]) }}">{{ substr(ucFirst($value->cat_name),0,20) }}</a>
                            </li>
                            @endforeach
                        ...
                        <div class="sidebar__widget-content">
                           <div class="sidebar__author">
                              <div class="sidebar__author-thumb">
                                 <img src="{{ url('/product_page') }}/imgs/blog/blog-10.jpg"
                    alt="">
                </div>
                           ...
                           <div class="sidebar__post">
                              <div class="rc__post d-flex align-items-center">
                                 <div class="rc__post-thumb">
                                    <a href="{{ route('popularDeals') }}"><img
                src="{{ url('/product_page') }}/imgs/blog/blog-11.jpg" alt=""></a>
            </div>
            ...
            <div class="rc__post d-flex align-items-center">
                <div class="rc__post-thumb">
                    <a href="{{ route('popularDeals') }}"><img
                            src="{{ url('/product_page') }}/imgs/blog/blog-12.jpg" alt=""></a>
                </div>
                <div class="rc__post-content">
                    <h4 class="rc__post-title">
            ...
            <div class="rc__post d-flex align-items-center">
                <div class="rc__post-thumb">
                    <a href="{{ route('popularDeals') }}"><img
                            src="{{ url('/product_page') }}/imgs/blog/blog-13.jpg" alt=""></a>
                </div>
                <div class="rc__post-content">
                    <h4 class="rc__post-title">
                        <a href="{{ route('popularDeals') }}">Starting and Growing Web Design in
                            2022</a>
                    </h4>
                    <div class="rc__meta">
                        <span>
                                ...
                                @if($key<=9)
                                    <div class="rc__post d-flex align-items-center">
                                        ...
                                        <div class="rc__post-content">
                                            <h4 class="rc__post-title">
                                                <a
                                                    href="{{ route('PopularService', ['id' => $value->id]) }}">{{ $value->product_name }}</a>
                                            </h4>
                                            {{-- <div class="rc__meta">
                                       <span>
                                          <svg width="15" height="15" viewBox="0 0 15 15" fill="none"
