                                                 ...
                                                 <tbody>
                                                    ...
                                                    <tr>
                                                       <td class="m_-1377519352946152473content" style="font-family:Open Sans,-apple-system,BlinkMacSystemFont,Roboto,Helvetica Neue,Helvetica,Arial,sans-serif;padding:40px 48px">
                                                          <p style="margin:0 0 1em">Dear <?php echo e($statement['giftCardHolderDetails']['recipient_name']?$statement['giftCardHolderDetails']['recipient_name']:$statement['giftCardHolderDetails']['your_name']); ?>,</p>
                                                          <p>We’ve attached your latest Giftcard Redeem Statement. You’ll be able to see the summary of transactions made for the giftcard <?php echo e($statement['result'][0]['giftnumber']); ?>.</p>
                                                         <table border="1" cellspacing="0" cellpadding="0" style="font-family:Open Sans,-apple-system,BlinkMacSystemFont,Roboto,Helvetica Neue,Helvetica,Arial,sans-serif;border-collapse:collapse;width:100%"> 
                                                           <tr>
                                                             ...
                                                             <?php $__currentLoopData = $statement['result']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                             <tr>
                                                             ...
                                                             <tr>
                                                             <td colspan="4"></td><th>Total Amount</th><td><?php echo e($statement['TotalAmount']); ?></td>
                                                             </tr>
                                                             </table>
...
<?php /**PATH /home/u929332160/domains/myforevermedspa.com/public_html/resources/views/email/Giftstatement.blade.php ENDPATH**/ ?>