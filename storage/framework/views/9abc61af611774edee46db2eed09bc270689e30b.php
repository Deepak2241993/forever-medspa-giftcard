               ...
               <div class="col-11 col-sm-9 col-md-7 col-lg-6 text-center p-0 mt-3 mb-2">
                   <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                       ...
                       <div class="button-group ml-6 mb-4">
                        <button type="button" class="btn btn-light active" id="someone" onclick="giftCardSentType('someone')"><i class="fa fa-gift" aria-hidden="true"></i> Someone else</button>
                        <button type="button" class="btn btn-light" id="self" onclick="giftCardSentType('self')"><i class="fa fa-user" aria-hidden="true"></i> Yourself</button>
                    </div>
                       <div class="row">
                           <div class="col-md-12 mx-0">
                            <input type="hidden" value="" id="fix_amount" class="fix_amount" placeholder="fix Amount">
                            <input type="hidden" value="" id="giftcard_amount" class="giftcard_amount" placeholder="pay Amount Without Discount">
                            <input type="hidden" value="" name="discount" id="discount" class="discount" placeholder="discount">
                            <?php if($errors->any()): ?>
                            ...
                            <?php endif; ?>
                               <form id="msform" class="some_one_else_div" Method="post"action="<?php echo e(route('giftcard-purchase')); ?>">
                                 <?php echo csrf_field(); ?>
                                   <!-- progressbar -->
                                   <ul id="progressbar">
                                   ...
                                   <section id="o_one">
                                       <ul class="list-group">
                                           <li class="list-group-item">
                                               ...
                                               <div class="right-content">
                                                ...
                                                <button class="btn btn-warning" type="button" onclick="fixamount(25, this)">Buy</button>
                                               </div>
                                           </li>
                                           <li class="list-group-item">
                                               ...
                                               <button class="btn btn-warning" type="button" onclick="fixamount(50, this)">Buy</button>
                                            </div>
                                           </li>
                                           <li class="list-group-item">
                                               ...
                                               <button class="btn btn-warning" type="button" onclick="fixamount(75, this)">Buy</button>
                                               </div>
                                           </li>
                                           <li class="list-group-item">
                                               ...
                                               <button class="btn btn-warning" type="button" onclick="fixamount(100, this)">Buy</button>
                                               </div>
                                           </li>
                                           <li class="list-group-item">
                                               ...
                                               <div class="row">
                                                   <div class="col-md-10" style="max-width: 90%;">
                                                       <input class="form-control" type="number" name="amount" onkeyup="CustomeamountOther()" onkeydown="hidebutton()" step="1" min="25" max="2000" id="customeamount_other" size="8" placeholder="$25" onkeypress="return (event.charCode != 8 && event.charCode == 0 || (event.charCode >= 48 && event.charCode <= 57))">
                                                   </div>
                                       ...
                                       <input type="button" id="check_amount_other_button"  name="next" class="next action-button"  value="Next Step"/>
                                   </section>
                                   <section id="o_two">
                                       <div class="form-card">
                                          <h2 class="qtyshow" class="text-warning"></h2>
                                               <div class="row">
                                                   ...
                                                   <div class="mb-3 col-lg-12 self">
                                                       ...
                                                       <select class="form-control giftcard_qty" name="qty" id="qty" onchange="qtychange()">
                                                           <?php for($i=1; $i<=10;$i++): ?>
                                                               <option value="<?php echo e($i); ?>"<?php echo e($i==1?'selected':''); ?>><?php echo e($i); ?></option>
                                                           <?php endfor; ?>
                                                       </select>
                                                       
                                                       <input type="hidden"  name="user_token" value="FOREVER-MEDSPA" class="user_token">
                                                   </div>
                                                   <div class="mb-3 col-lg-12 self">
                                                       <label for="your_name" class="form-label">Your name<span class="text-danger">*</span></label>
                                                       <input class="form-control" type="text" name="your_name" value="" placeholder="From Name" id="your_name" autocomplete="off">
                                                   ...
                                                   <div class="mb-3 col-lg-12">
                                                       ...
                                                       <input class="form-control" type="text" name="recipient_name" value="" placeholder="To Name" id="recipient_name" autocomplete="off">
                                                       <span id="recipient_name_error" class="text-danger"></span>
                                                   </div>
                                                   <div class="mb-3 col-lg-12">
                                                       <label for="message" class="form-label">Message</label>
                                                       <textarea name="message" id="message" autocomplete="off" rows="4" class="form-control"></textarea>
                                                   </div>
                                                   <div id="emailfields">
                                                       <div class="mb-3 col-lg-12 mt-2" id="giftSendByEmail">
                                                           <label for="gift_send_to" class="form-label"><b>What email address should we send the gift card to?<span class="text-danger">*</span></b></label>
                                                           <input class="form-control" type="email" name="gift_send_to" value="" placeholder="Recipient Email Address" id="gift_send_to" autocomplete="off">
                                                           <span id="gift_send_to_error" class="text-danger"></span>
                                                        </div>
                                                       <div class="mb-3 col-lg-12 mt-2" id="giftSendByEmail">
                                                           <label for="receipt_email" class="form-label"><b>Your email address (for the receipt)<span class="text-danger">*</span></b></label>
                                                           <input class="form-control" type="email" name="receipt_email" value="" placeholder="Sender's Email address (for the receipt)" id="receipt_email" autocomplete="off">
                                                       ...
                                                       <div class="mb-3 col-lg-12" id="future_date_section">
                                                           ...
                                                           <input class="form-control" id="in_future" type="date" name="in_future" autocomplete="off">
                                                           <span id="error_msg" class="text-danger"></span>
                                                       </div>
                                                   </div>
                                                   <div class="mb-3 col-lg-8">
                                                    <input class="text-uppercase form-control" type="text" placeholder="Have a promo code?" onkeyup="calculateWithoutGiftcard()" name="coupon_code" id="coupon_code">
                                                </div>
                                                <div class="col-lg-4">
                                                    <button class="btn btn-warning couponValidate" type="button" onclick="CheckCoupon()">Apply Code</button>
                                                </div>
                                               </div>
                                       ...
                                       <input type="button" name="previous"onclick="hidebutton()" class="previous action-button-previous hide_button" value="Go Back"/>
                                       <input type="button" name="next" class="action-button" onclick="finalcalculation()" value="Next Step"/>
                                   </section>
                                   <section id="o_three">
                                       <div class="form-card">
                                          ...
                                          <input type="text" name="transaction_amount"  class="form-control transaction_amount" value="" readonly>
                                          <input type="hidden" value="" name="discount" class="fdiscount" placeholder="discount">
                               ...
                               <form id="msform" class="self_div" Method="post"action="<?php echo e(route('giftcard-purchase')); ?>">
                                 <?php echo csrf_field(); ?>
                                   <!-- progressbar -->
                                   <ul id="progressbar">
                                       <li class="active" id="account"><strong>Account</strong></li>
                                   ...
                                   <section id="o_five">
                                       <ul class="list-group">
                                           ...
                                           <li class="list-group-item">
                                               ...
                                               <div class="row">
                                                   <div class="col-md-10" style="max-width: 90%;">
                                                       <input class="form-control" type="number" step="1" name="amount" min="25" max="2000" id="customeamount_self" onkeyup="CustomeamountSelf()" onkeydown="hidebutton()" size="8" placeholder="$25" onkeypress="return (event.charCode != 8 && event.charCode == 0 || (event.charCode >= 48 && event.charCode <= 57))">
                                                   </div>
                                       ...
                                       <input type="button" id="check_amount_self_button"  name="next" class="next action-button" value="Next Step"/>
                                   </section>
                                   <section id="o_six">
                                       <div class="form-card">
                                          <h2 class="qtyshow" class="text-warning"></h2>
                                           ...
                                           <div>
                                               <div class="row">
                                                   <div class="mb-3 col-lg-12 self">
                                                       <label for="to_1" class="form-label">Quantity</label>
                                                       <select class="form-control giftcard_qty" id="sqty" onchange="oqtychange()" name="qty">
                                                           <?php for($i=1; $i<=10;$i++): ?>
                                                               <option value="<?php echo e($i); ?>" <?php echo e($i==1?'selected':''); ?>><?php echo e($i); ?></option>
                                                           <?php endfor; ?>
                                                       </select>

                                                       <input type="hidden" name="user_token" value="FOREVER-MEDSPA" class="user_token" readonly>
                                                   </div>
                                                   <div class="mb-3 col-lg-12 self">
                                                       <label for="syour_name" class="form-label">Your Name<span class="text-danger">*</span></label>
                                                       <input class="form-control" type="text" name="your_name" value="" placeholder="From Name" id="syour_name" autocomplete="off">
                                                   ...
                                                   <div class="mb-3 col-lg-12 mt-2" id="giftSendByEmail">
                                                       ...
                                                       <input class="form-control" type="email" name="gift_send_to" value="" placeholder="Enter Your Email" id="sto_email" autocomplete="off">
                                                       <span id="sgift_send_to_error" class="text-danger"></span>
                                                    </div>
                                                  
                                                       <div class="col-lg-8">
                                                           <input class="text-uppercase form-control" type="text" placeholder="Have a promo code?" onkeyup="scalculateWithoutGiftcard()" name="coupon_code" id="scoupon_code" message="">
                                                       </div>
                                                       <div class="col-lg-4">
                                                           <button class="btn btn-warning right-content" type="button" onclick="SCheckCoupon()">Apply Code</button>
                                                       </div>
                                                       <div class="text-success Coupon_success" style="margin-left: 20px;"></div>
                                                       <div class="text-danger Coupon_error" style="margin-left: 20px;"></div>
                                       ...
                                       <input type="button" name="previous" class="previous action-button-previous" onclick="hidebutton()" value="Go Back"/>
                                       <input type="button" name="next" class="action-button" onclick="sfinalcalculation()" value="Next Step"/>
                                   </section>
                                   <section id="o_seven">
                                    <div class="form-card">
                                        <h2 class="fs-title">Transaction Amount</h2>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\giftcard\resources\views/gift/gift_sale.blade.php ENDPATH**/ ?>