...
padding-top: 200px;
    ...
    background-image: url(<?php echo e(asset('giftcards/images/failed.png')); ?>);
        ...
        <fieldset id="finishbox">
            <div class="form-card">
                ...
                <div class="row justify-content-center">
                    <div class="col-7 ">
                    <h4 class="tran">Payment is Failed.</h4>
...
<?php echo $__env->make('layouts.front-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\MedsapGiftCardNew\resources\views/stripe/failed.blade.php ENDPATH**/ ?>