        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box text-bg-warning">
                        <div class="inner">
                            <a href="<?php echo e(route('keywords_reports')); ?>" class="small-box-footer">
                            <h3><?php echo e($search_keyword); ?></h3>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\MedsapGiftCardNew\resources\views/admin/admin_dashboad.blade.php ENDPATH**/ ?>