                            ...
                            <div class="row align-items-left g-5" style="border: dotted;border-color: gold; margin-bottom:20px">
                                ...
                                <div class="col-md-9 col-sm-12">
                                    <div class="single-coupon-content">
                                        ...
                                        <p><?php echo e($value->title?$value->redeem_description:''); ?></p>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.front-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\giftcard\resources\views/pages_for_occasion/christmas.blade.php ENDPATH**/ ?>