                               ...
                               <form id="msform" class="some_one_else_div" Method="post"action="<?php echo e(route('giftcard-purchase')); ?>">
                                 <?php echo csrf_field(); ?>
                                   ...
                                   <section id="o_four">
                                       ...
                                       cursor: pointer;
                                       padding: 10px 5px;
                                       margin: 10px 5px;"Name="Submit" style="margin-top: 15px; border-radius: 6px; width: 130px;"onclick="this.value='Please Wait ...';alert('Please press Ok to print the invoice');" />
