                                                 ...
                                                 <tbody>
                                                    <tr>
                                                       <td class="m_-1377519352946152473content" align="center" style="font-family:Open Sans,-apple-system,BlinkMacSystemFont,Roboto,Helvetica Neue,Helvetica,Arial,sans-serif;padding:40px 48px 0">
                                                          <h1 style="font-weight:300;font-size:28px;line-height:130%;margin:16px 0 0" align="center">Giftcard Statement</h1>
                                                       </td>
                                                    </tr>
                                                    <tr>
                                                       <td class="m_-1377519352946152473content" style="font-family:Open Sans,-apple-system,BlinkMacSystemFont,Roboto,Helvetica Neue,Helvetica,Arial,sans-serif;padding:40px 48px">
                                                          <p style="margin:0 0 1em">Dear <?php echo e($gifcardCancelData['receiverAndSenderDetails']['your_name']); ?>,</p>
                                                          <p>As per your request, the Giftcard with serial number :  <?php echo e($gifcardCancelData['result'][0]['giftnumber']); ?> has been cancelled and is considered invalid for all further use.</p>
                                                         <table border="1" cellspacing="0" cellpadding="0" style="font-family:Open Sans,-apple-system,BlinkMacSystemFont,Roboto,Helvetica Neue,Helvetica,Arial,sans-serif;border-collapse:collapse;width:100%"> 
                                                           <tr>
                                                             ...
                                                             <?php $__currentLoopData = $gifcardCancelData['result']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                             <tr>
                                                               <td><?php echo e($key+1); ?></td>
                                                               <td><?php echo e($item['transaction_id']); ?></td>
                                                               <td><?php echo e($item['giftnumber']); ?></td>
                                                               <td><?php echo e(date('m-d-Y',strtotime($item['updated_at']))); ?></td>
                                                             ...
                                                             <tr>
                                                             <td colspan="4"></td><th>Refundable  Amount</th><td><?php echo e($gifcardCancelData['TotalAmount']); ?></td>
                                                             </tr>
                                                             </table>
                                                          <table cellspacing="0" cellpadding="0" style="font-family:Open Sans,-apple-system,BlinkMacSystemFont,Roboto,Helvetica Neue,Helvetica,Arial,sans-serif;border-collapse:collapse;width:100%">
                                                             <tbody>
                                        ...
                                        <td style="font-family:Open Sans,-apple-system,BlinkMacSystemFont,Roboto,Helvetica Neue,Helvetica,Arial,sans-serif;padding-top:48px;padding-bottom:48px">
                                           <table cellspacing="0" cellpadding="0" style="font-family:Open Sans,-apple-system,BlinkMacSystemFont,Roboto,Helvetica Neue,Helvetica,Arial,sans-serif;border-collapse:collapse;width:100%;color:#9eb0b7;text-align:center;font-size:13px">
                                              <tbody>
                                                 ...
                                                 <tr>
                                                    <td style="font-family:Open Sans,-apple-system,BlinkMacSystemFont,Roboto,Helvetica Neue,Helvetica,Arial,sans-serif;padding-right:24px;padding-left:24px">ⓒ <?php echo e(date('Y')); ?> Forever MedSpa Wellness Center<br><a href="https://forevermedspanj.com/" style="color:#9eb0b7;text-decoration:none" target="_blank" data-saferedirecturl="https://forevermedspanj.com/">Home</a> | 
...
<?php /**PATH /home/u929332160/domains/myforevermedspa.com/public_html/resources/views/email/GiftCardCancel.blade.php ENDPATH**/ ?>