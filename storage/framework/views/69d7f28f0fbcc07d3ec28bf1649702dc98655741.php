   ...
   <head>
      ...
      <style type="text/css">
         ...
         * {
         ...
         table, td { color: #000000; } #u_body a { color: #0000ee; text-decoration: underline; } @media (max-width: 480px) { #u_content_heading_3 .v-font-size { font-size: 20px !important; } #u_content_heading_4 .v-font-size { font-size: 40px !important; } #u_content_heading_4 .v-line-height { line-height: 120% !important; } #u_content_heading_1 .v-font-size { font-size: 20px !important; } #u_content_text_2 .v-font-size { font-size: 14px !important; } #u_content_text_2 .v-line-height { line-height: 130% !important; } #u_content_heading_2 .v-font-size { font-size: 27px !important; } #u_content_heading_2 .v-line-height { line-height: 120% !important; } #u_content_button_3 .v-size-width { width: 68% !important; } #u_content_button_2 .v-size-width { width: 72% !important; } #u_content_menu_1 .v-padding { padding: 5px 25px !important; } }
      </style>
                           ...
                           <tbody>
                              <tr>
                                 <td style="overflow-wrap:break-word;word-break:break-word;padding:30px 10px;font-family:arial,helvetica,sans-serif;" align="left">
                                    <div align="center">
                                       <a class="navbar-brand" href="https://myforevermedspa.com"><img src="https://forevermedspanj.com/wp-content/uploads/forever-color.fw_.png" alt="image" style="height:70px;"></a>
                                       </a>
                                    </div>
                                 </td>
                              </tr>
         ...
         <tr style="vertical-align: top">
                           ...
                           <div style="background-color: #000000;height: 100%;width: 100% !important;">
                              <div style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;">
                                 <table id="u_content_heading_3" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                    <tbody>
                                       <tr>
                                          <td style="overflow-wrap:break-word;word-break:break-word;padding:60px 0px 0px;font-family:arial,helvetica,sans-serif;" align="left">
                                             <h1 class="v-line-height v-font-size" style="margin: 0px; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word; font-family: Epilogue; font-size: 22px; font-weight: 400;">Celebrate with Us!</h1>
                                          </td>
                                       </tr>
                                    </tbody>
                                 </table>
                                    ...
                                    <tbody>
                                       <tr>
                                          <td style="overflow-wrap:break-word;word-break:break-word;padding:0px;font-family:arial,helvetica,sans-serif;" align="left">
                                             <h1 class="v-line-height v-font-size" style="margin: 0px; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word; font-family: Epilogue; font-size: 46px; font-weight: 400;">A Special Gift</h1>
                                          </td>
                                       </tr>
                                    </tbody>
                                 </table>
                                 <table id="u_content_heading_1" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                    <tbody>
                                       <tr>
                                          <td style="overflow-wrap:break-word;word-break:break-word;padding:0px;font-family:arial,helvetica,sans-serif;" align="left">
                                             <h1 class="v-line-height v-font-size" style="margin: 0px; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word; font-family: Epilogue; font-size: 22px; font-weight: 400;"> <?php if(!empty($mail_data->recipient_name)): ?><?php echo e('Received From '.ucFirst($mail_data->your_name)); ?> <?php else: ?><?php echo e('Just for You'); ?> <?php endif; ?></h1>
                                          </td>
                                       </tr>
                                    </tbody>
                                 </table>
                                    ...
                                    <tbody>
                                       <tr>
                                          <td style="overflow-wrap:break-word;word-break:break-word;padding:40px 10px 10px;font-family:arial,helvetica,sans-serif;" align="left">
                                             <div class="v-line-height v-font-size" style="font-size: 14px; line-height: 140%; text-align: center; word-wrap: break-word; margin-left:20px">
                                                <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                                   <tbody>
                                                      <tr>
                                                         <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                                                            <div class="v-line-height v-font-size" style="font-size: 14px; line-height: 140%; word-wrap: break-word;">
                                                               <p style="line-height: 24px;">Dear <b><?php if(!empty($mail_data->recipient_name)): ?><?php echo e(ucFirst($mail_data->recipient_name)); ?> <?php else: ?><?php echo e(ucFirst($mail_data->your_name)); ?> <?php endif; ?> </b>,<br>
                                                ...
                                                <p style="line-height: 130%;">At <b>Forever MedSpa</b>, we believe that every special occasion deserves to</p>
                                    ...
                                    <tbody>
                                       <tr>
                                          <td style="overflow-wrap:break-word;word-break:break-word;padding:30px 0px 0px;font-family:arial,helvetica,sans-serif;" align="left">
                                             <h1 class="v-line-height v-font-size" style="margin: 0px; color: #000000; line-height: 140%; text-align: center; word-wrap: break-word; font-family: Epilogue; font-size: 40px; font-weight: 700;">Your Exclusive Gift:</h1>
                                          </td>
                                       </tr>
                                    </tbody>
                                 </table>
                  							...
                  							<tbody>
                  								<tr>
                  									<td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
														...
														<span class="v-line-height v-padding" style="display:block;padding:10px 20px;line-height:120%;">
														<span style="line-height: 25.2px;">
															<?php echo e($value->giftnumber); ?>
			...
			<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
               ...
               <div class="u-row-container" style="padding: 5px 0px 0px;background-color: transparent">
                  ...
                  Sent by Forever Medspa Forever Medspa.<br>
                  ...
                  <a href="https://www.facebook.com/ForeverMedSpaNJ/" title="Facebook" target="_blank">
                  <img src="<?php echo e(url('/')); ?>/email_template/facebook.png" alt="Facebook" title="Facebook" width="32" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                  </a>
                  </td></tr>
                  </tbody></table>
                  <table align="left" border="0" cellspacing="0" cellpadding="0" width="32" height="32" style="width: 32px !important;height: 32px !important;display: inline-block;border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;margin-right: 15px">
                  <tbody><tr style="vertical-align: top"><td align="left" valign="middle" style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                  <a href="https://x.com/ForeverMedSpaNJ" title="Twitter" target="_blank">
                  <img src="<?php echo e(url('/')); ?>/email_template/twitter.png" alt="Twitter" title="Twitter" width="32" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                  </a>
                  </td></tr>
                  </tbody></table>
                  ...
                  <tbody><tr style="vertical-align: top"><td align="left" valign="middle" style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                  <a href="https://www.instagram.com/forevermedspa/?hl=en" title="Instagram" target="_blank">
                  <img src="<?php echo e(url('/')); ?>/email_template/instagram.png" alt="Instagram" title="Instagram" width="32" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                  </a>
                  </td></tr>
                  </tbody></table>
                  </div>
...
</html><?php /**PATH C:\xampp\htdocs\MedsapGiftCardNew\resources\views/email/giftcard.blade.php ENDPATH**/ ?>