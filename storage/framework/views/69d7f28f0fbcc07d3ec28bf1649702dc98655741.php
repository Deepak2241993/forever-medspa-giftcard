                                                      ...
                                                      <tr>
                                                         <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                                                            <div class="v-line-height v-font-size" style="font-size: 14px; line-height: 140%; word-wrap: break-word;">
                                                               <p style="line-height: 24px;">Dear <b>Deepak</b>,<br>
                                                      ...
                                                      <tr>
                                                         <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                                                            <div class="v-line-height v-font-size" style="font-size: 14px; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                               ...
                                                               <h3 style="line-height: 140%;"> <?php if(!empty($mail_data->recipient_name)): ?>
                                                                  ...
                                                                  <?php else: ?>
                                                                  You have received a gift card purchase 1 x $25 gift card to use at<br>Forever Medspa.
                                                               </h3>
                                                               <?php endif; ?>
                                                            </div>
                                                         </td>
